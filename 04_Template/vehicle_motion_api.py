...
class General():
    ...
    def subcribe_carla_topics(self):
        ...
        rospy.Subscriber(   "/carla/hero/is_in_checkpoint", Bool, self.get_is_in_checkpoint_msg)
    ...
    def get_is_in_checkpoint_msg(self, msg):
        """
        gets is_in_checkpoint
        """
        self.is_in_checkpoint = msg.data
